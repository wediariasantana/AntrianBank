...
class SettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        flash()->success('Akun telah di Updated');
    ...
    public function companyUpdate(Request $request)
    {
        ...
        flash()->success('Perusahaan telah di Updated');
        return redirect()->route('settings');
    }
    ...
    public function overmissedUpdate(Request $request)
    {
        ...
        flash()->success('Pengaturan telah di Updated');
        return redirect()->route('settings');
    }
    ...
    public function localeUpdate(Request $request)
    {
        ...
        flash()->success('Bahasa telah di Updated');
        return redirect()->route('settings');
    }
}
