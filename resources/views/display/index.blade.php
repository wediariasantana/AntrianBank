...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/w3css.css') }}">
@section('content')
        ...
        <div class="col m4">
            ...
            <div class="card-panel center-align" style="margin-bottom:0">
                <div style="border-bottom:1px solid #ddd">
                    <span id="num1" style="font-size:70px;font-weight:bold;line-height:1.45">{{ $data[1]['number'] }}</span><br>
                    <small id="cou1" style="font-size:30px">{{ $data[1]['counter'] }}</small>
                </div>
                <div style="border-bottom:1px solid #ddd">
                    <span id="num2" style="font-size:70px; font-weight:bold;line-height:1.45">{{ $data[2]['number'] }}</span><br>
                    <small id="cou2" style="font-size:30px">{{ $data[2]['counter'] }}</small>
                </div>
                <div style="border-bottom:1px solid #ddd">
                    <span id="num3" style="font-size:70px;font-weight:bold;line-height:1.45">{{ $data[3]['number'] }}</span><br>
                    <small id="cou3" style="font-size:30px">{{ $data[3]['counter'] }}</small>
                </div>
            </div>
        </div>
        <div class="col m8">
            ...
            <div class="card-panel center-align" style="margin-bottom:0">
                <span style="font-size:40px">{{ trans('messages.display.token') }}</span><br>
                <span class=" w3-text-orange" id="num0" style="font-size:130px;font-weight:bold;line-height:1.5">{{ $data[0]['number'] }}</span><br>
                <span style="font-size:40px">{{ trans('messages.display.please') }} {{ trans('messages.display.proceed_to') }}</span><br>
                <span class=" w3-text-orange" id="cou0" style="font-size:80px; line-height:1.5">{{ $data[0]['counter'] }}</span>
            </div>
        </div>
    </div>
