            ...
            <div class="col s12 z-depth-4 card-panel">
                <form class="login-form" action="{{ route('post_login') }}" method="post" onsubmit="return load()">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            <a href="{{ route('add_to_queue') }}" class="btn waves-effect waves-light col s12">Lanjut Request Antrian</a>
                        </div>
                    </div>
                    <!-- <div class="row">
                        <div class="input-field col s12 m12 l12">
                            <p class="margin medium-small"><a href="{{ route('get_email') }}">Lupa password ?</a></p>
                        </div>
                    </div> -->
                </form>
            </div>
