...
<html>
    <head>
        ...
        <title>Lupa Password | Sistem Antrian</title>
    ...
    <body class="teal">
        ...
        <div id="login-page" class="row">
                ...
                <form class="login-form" action="<?php echo e(route('post_email')); ?>" method="post" onsubmit="return load()">
                    ...
                    <div class="row">
                        <div class="input-field col s12 center">
                            <p class="center login-form-text" style="font-size:23px;margin-top:5px">Sistem Antrian</p>
                            <p class="center login-form-text" style="letter-spacing:1px">Masukkan Email</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <button type="submit" class="btn waves-effect waves-light col s12">Kirim Link untuk Reset</button>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="row center-align white-text" style="margin-bottom:0">
                <span>Powered by <a href="http://www.justlabtech.com" target="_blank" style="color:#ccc">Wedi Aria Santana</a></span>
            </div>
        </div>
