                                    ...
                                    <form id="noti" action="<?php echo e(route('dashboard_store')); ?>" method="post">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m8">
                                                <label for="notification"><?php echo e(trans('messages.dashboard.notification_text')); ?></label><br><br>
                                            ...
                                            <div class="input-field col s12 m1">
                                                <label for="size"><?php echo e(trans('messages.font_size')); ?></label><br><br>
                                            ...
                                            <div class="input-field col s12 m2">
                                                <label for="color"><?php echo e(trans('messages.color')); ?></label><br><br>
