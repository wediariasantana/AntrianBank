...
<html>
    <head>
        ...
        <title><?php echo $__env->yieldContent('title'); ?> | Sistem Antrian</title>
            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                       <ul> 
                            <li><a href="<?php echo e(route('add_to_queue')); ?>" style="font-weight:400"><?php echo e(trans('messages.mainapp.issue_url')); ?></a></li>
                       </ul>
                        ...
                        <ul>
                            <li><a href="<?php echo e(route('display')); ?>" style="font-weight:400;"><?php echo e(trans('messages.mainapp.display_url')); ?></a></li>
                        </ul>
                    </div>
                </nav>
            </div>
